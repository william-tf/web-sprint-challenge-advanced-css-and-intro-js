...
function getArtistByIndex(array, index) {
  let did = array[index].id;
  let name = array[index].name;
   return `The artist at index ${did} is ${name}.`; 
  }
...
function addArtist(id, name, years, genre, nationality, bio, arr){
  arr.push({id, name, years, genre, nationality, bio})
  return arr;
    /* Code here */

  }
addArtist(20, "William", 21, "modern", "american", "likes to make fun of other artists", artists);
